 ...
 *
 */
@JobHander(value = "d_region_hh")
@Service
public class D_REGION_HH extends CollectBase {


	@SuppressWarnings("unused")
	private static final Logger Logger = LoggerFactory.getLogger(D_REGION_HH.class);
	...
	protected Map<String, Object> param() {
		...
		map.put("times", "20171207000000");//时间得处理
		map.put("staLevels", "014");
		map.put("elements",
